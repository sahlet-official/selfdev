...
1. Практики
   - Практика упражнений для:
     ...
     - научиться разрабатывать и внедрять шаблоны поведения;
...
2. Понимание потребностей
   ...
   - Научитесь распознавать, какие потребности являются более приоритетными прямо сейчас.
   - Научитесь уделять время каждой потребности.
3. Здоровье
