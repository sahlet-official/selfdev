...
1. Практики
   - Практика упражнений для:
     ...
     - восстановить структуры торможения так, чтоб она была даже эффективнее чем раньше, могла в нужный момент за небольшой промежуток времени расслабить возбуждение в нейронной ткани и поддерживать это расслабление так долго как нужно, или оставить расслабленным, пока не понадобится возбужоение, если оно вообще понадобится.
